...
const HeroSection = () => {
    return (
        // PERUBAHAN 1: Tambahkan style untuk menjadi "wadah" bagi video
        <section 
            className="hero is-fullheight is-bold" 
            style={{ position: 'relative', overflow: 'hidden' }}
        >
            {/* PERUBAHAN 2: Pindahkan elemen <video> ke sini */}
            <video
                autoPlay loop muted playsInline
                style={{
                    position: 'absolute', // Diposisikan relatif terhadap section
                    top: 0,
                    left: 0,
                    width: '100%',
                    height: '100%',
                    objectFit: 'cover',
                    zIndex: 0, // Berada di belakang konten hero
                }}
            >
            ...
            {/* Overlay gelap ditempatkan di atas video */}
            <div className="hero-body" style={{backgroundColor: 'rgba(0,0,0,0.6)', zIndex: 1, position: 'relative'}}>
                <div className="container has-text-centered">
                    ...
                    >
                        Rasakan sensasi pedas otentik dari Sambal Juara, dibuat sepenuh hati dengan resep warisan nusantara.
                    </motion.h2>
                    <motion.a 
                        href="#produk" 
